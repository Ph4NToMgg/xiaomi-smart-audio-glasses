...
export const ScrollAnimationSection: React.FC<ScrollAnimationSectionProps> = ({ frames }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-[450vh] bg-[#070709] bg-mesh-glow bg-grid-pattern overflow-x-hidden"
      id="story-animation"
    >
      <ScrollController scrollProgress={scrollProgress} />

      {/* Sticky Viewport Stage */}
      <div className="sticky top-0 left-0 w-full h-screen overflow-hidden flex items-center justify-center p-6 sm:p-12">
        ...
        {/* Framed Canvas Container (Crisp 1:1 contain scale, zero pixelation) */}
