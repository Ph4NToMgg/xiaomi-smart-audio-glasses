...
import { Glasses, ArrowUp } from 'lucide-react';
  ...
  return (
    <footer className="bg-[#030304] border-t border-zinc-900 py-16 text-zinc-400 font-mono text-xs">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-12">
          ...
          <div className="space-y-4 max-w-sm">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-xl bg-yellow-400 flex items-center justify-center text-black font-extrabold font-heading text-base">
                mi
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              <h4 className="text-white font-bold mb-3 uppercase tracking-widest text-[11px]">Product</h4>
            ...
            <div>
              <h4 className="text-white font-bold mb-3 uppercase tracking-widest text-[11px]">Support</h4>
              <ul className="space-y-2 text-zinc-500">
            ...
            <div>
              <h4 className="text-white font-bold mb-3 uppercase tracking-widest text-[11px]">Global</h4>
              <ul className="space-y-2 text-zinc-500">
        ...
        <div className="pt-8 border-t border-zinc-900/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-zinc-600 text-[11px]">
          <div>
          ...
          <button
            onClick={scrollToTop}
            className="flex items-center gap-2 text-zinc-400 hover:text-yellow-400 transition-colors p-2 rounded-xl bg-zinc-900 border border-zinc-800"
          >
