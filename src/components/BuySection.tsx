      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-4xl sm:text-6xl font-extrabold text-white font-heading leading-tight mb-4">
            Step Into <span className="text-gradient-yellow">Acoustic Vision</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div
            ...
            className={`glass-panel rounded-3xl p-8 border cursor-pointer transition-all relative flex flex-col justify-between ${
              selectedEdition === 'standard'
                ? 'border-yellow-500/80 bg-zinc-900/90 yellow-border-glow'
          ...
          >
            <div>
              ...
              <div className="flex items-baseline gap-2 mb-6">
                ...
                <span className="text-[10px] font-mono font-bold bg-yellow-400/20 text-yellow-400 px-2 py-0.5 rounded">
                  Save $50
                </span>
              </div>

              <ul className="space-y-3 mb-8 text-xs font-mono text-zinc-300">
            ...
            <button className="w-full py-3.5 rounded-2xl bg-yellow-400 hover:bg-yellow-300 text-black font-bold text-xs uppercase font-heading tracking-wide transition-all yellow-glow">
          ...
          <div
            ...
            className={`glass-panel-gold rounded-3xl p-8 border cursor-pointer transition-all relative flex flex-col justify-between ${
              selectedEdition === 'deluxe'
                ? 'border-yellow-400 bg-zinc-900/95 yellow-border-glow'
                : 'border-yellow-500/30 hover:border-yellow-500/60'
            }`}
          >
            {/* Best Value Badge */}
            <div className="absolute -top-3.5 right-8 px-3 py-1 rounded-full bg-yellow-400 text-black text-[10px] font-extrabold uppercase font-mono shadow-md">
              BEST VALUE GIFT SET
            </div>
            ...
            <button className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-500 text-black font-extrabold text-xs uppercase font-heading tracking-wide transition-all shadow-[0_0_25px_rgba(255,199,0,0.4)] hover:scale-[1.02]">
        ...
        {/* Guarantees Bar */}
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto text-center font-mono text-xs text-zinc-400">
